================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ComClientCalcAddMFC プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ComClientCalcAddMFC には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ComClientCalcAddMFC アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
ComClientCalcAddMFC.h
   ...
   CComClientCalcAddMFCApp アプリケーション クラスを宣言します。

ComClientCalcAddMFC.cpp
   これは、アプリケーション クラス CComClientCalcAddMFCApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ComClientCalcAddMFC.ico
   ...
   アイコンはメイン リソース ファイル ComClientCalcAddMFC.rc に含まれていま
   す。
...
res\Toolbar.bmp
   ...
   プをリソース エディタを使用して編集し、ComClientCalcAddMFC.rc ファイル内
...
ComClientCalcAddMFCDoc.h, ComClientCalcAddMFCDoc.cpp - ドキュメント
   これらのファイルは CComClientCalcAddMFCDoc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via CComClientCalcAddMFCDoc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

ComClientCalcAddMFCView.h, ComClientCalcAddMFCView.cpp - ドキュメントのビュー
   これらのファイルは CComClientCalcAddMFCView クラスを含みます。
   CComClientCalcAddMFCView オブジェクトは CComClientCalcAddMFCDoc オブジェクトを表示す
   るのに使用されます。

res\ComClientCalcAddMFCDoc.ico
   このファイルは、CComClientCalcAddMFCDoc クラスの MDI 子ウィンドウ用アイコンとし
   て使用されるアイコン ファイルです。このアイコンは、メイン リソースファイル 
   ComClientCalcAddMFC.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
   ...
   ComClientCalcAddMFC.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
